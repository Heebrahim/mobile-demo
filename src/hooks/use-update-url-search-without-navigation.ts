...
export function updateURLSearchWithoutNavigation(
  queryKey: string,
  queryValue: string,
) {
...
export function useUpdateURLSearchWithoutNavigation(
  queryKey: string,
  queryValue: string,
) {
  useEffect(() => {
    updateURLSearchWithoutNavigation(queryKey, queryValue)
  }, [queryKey, queryValue]);
}
